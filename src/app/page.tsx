    ...
    <Link href={href}>
      <span
        ...
        onMouseEnter={(e) => {
          ...
          e.currentTarget.style.boxShadow = mint
            ? `3px 3px 0px ${MINT}`
            : `3px 3px 0px ${BRUTAL_BLACK}`;
        }}
        onMouseLeave={(e) => {
          if (window.matchMedia("(prefers-reduced-motion: reduce)").matches) return;
    ...
    <div className="min-h-screen" style={{ background: BG_LIGHT }}>
      ...
      <nav className="fixed top-0 left-0 right-0 z-50" style={{ background: "#FFFFFF", borderBottom: `4px solid ${BRUTAL_BLACK}` }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link href="#features" className="font-bold text-sm transition-all duration-100 hover:underline underline-offset-4" style={{ color: BRUTAL_BLACK, textDecorationThickness: "3px", textDecorationColor: MINT }}>
                Features
              </Link>
              <Link href="#templates" className="font-bold text-sm transition-all duration-100 hover:underline underline-offset-4" style={{ color: BRUTAL_BLACK, textDecorationThickness: "3px", textDecorationColor: MINT }}>
                Templates
              </Link>
              {user ? (
                <Link href="/dashboard">
                ...
                <div className="flex items-center gap-3">
                  <Link href="/auth/login">
                    <span className="font-bold text-sm px-4 py-2" style={{ color: BRUTAL_BLACK }}>
                      Sign In
                    </span>
                  </Link>
                  <Link href="/auth/register">
                    <span
                      ...
                      style={{
                        border: `3px solid ${BRUTAL_BLACK}`,
                        boxShadow: `4px 4px 0px ${BRUTAL_BLACK}`,
                        background: "#FFFFFF",
                        color: BRUTAL_BLACK,
                      }}
                    >
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            style={{ borderTop: `3px solid ${BRUTAL_BLACK}`, background: "#FFFFFF" }}
          >
            <div className="px-4 py-4 space-y-3">
              ...
              {user ? (
                <Link href="/dashboard" onClick={() => setMobileMenuOpen(false)}>
                  <span className="block w-full text-center font-bold px-5 py-2.5" style={{ background: MINT, color: "#FFFFFF", border: `3px solid ${BRUTAL_BLACK}` }}>Dashboard</span>
                </Link>
              ) : (
                <>
                  <Link href="/auth/login" onClick={() => setMobileMenuOpen(false)}>
                    <span className="block w-full text-center font-bold px-5 py-2.5" style={{ border: `3px solid ${BRUTAL_BLACK}`, color: BRUTAL_BLACK }}>Sign In</span>
                  </Link>
                  <Link href="/auth/register" onClick={() => setMobileMenuOpen(false)}>
                    <span className="block w-full text-center font-bold px-5 py-2.5" style={{ background: BRUTAL_BLACK, color: "#FFFFFF", border: `3px solid ${BRUTAL_BLACK}` }}>Get Started Free</span>
                  </Link>
                </>
              )}
            </div>
      ...
      <section className="relative pt-32 pb-24 px-4 overflow-hidden" style={{ background: "#FFFFFF", borderBottom: `4px solid ${BRUTAL_BLACK}` }}>
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(${BRUTAL_BLACK} 1px, transparent 1px), linear-gradient(90deg, ${BRUTAL_BLACK} 1px, transparent 1px)`,
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div
                className="inline-flex items-center gap-2 px-4 py-2 font-bold text-sm mb-8"
                style={{
                  border: `3px solid ${BRUTAL_BLACK}`,
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 mb-12">
                <BrutalButton href={user ? "/dashboard" : "/auth/register"} mint size="lg">
                  Start Building <ArrowRight className="w-5 h-5" />
                </BrutalButton>
                <BrutalButton href="#features">
                  See How It Works
                </BrutalButton>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm font-bold" style={{ color: BRUTAL_BLACK }}>
                <span className="flex items-center gap-2">
                  <span className="w-5 h-5 flex items-center justify-center" style={{ background: MINT_DEEP, color: "#FFFFFF", fontSize: "12px" }}>✓</span>
                  No credit card
                </span>
                <span className="flex items-center gap-2">
                  <span className="w-5 h-5 flex items-center justify-center" style={{ background: MINT_DEEP, color: "#FFFFFF", fontSize: "12px" }}>✓</span>
            ...
            >
              <BrutalCard className="overflow-hidden">
                ...
                {/* Overlay badge */}
                <div
                  className="absolute top-4 left-4 px-3 py-1.5 font-bold text-xs"
                  style={{
                    background: MINT,
                    border: `3px solid ${BRUTAL_BLACK}`,
                    boxShadow: `3px 3px 0px ${BRUTAL_BLACK}`,
                    color: "#FFFFFF",
                  }}
                >
                  ✦ Drag & Drop
                ...
                <div
                  className="absolute bottom-4 right-4 px-3 py-1.5 font-bold text-xs"
                  style={{
                    background: "#FFFFFF",
                    border: `3px solid ${BRUTAL_BLACK}`,
                    color: BRUTAL_BLACK,
              ...
              <div
                className="absolute -bottom-6 -left-6 w-16 h-16 z-10"
                style={{ background: MINT, border: `4px solid ${BRUTAL_BLACK}`, transform: "rotate(12deg)" }}
              >
                <div className="w-full h-full flex items-center justify-center font-black text-white text-2xl" style={{ fontFamily: "monospace" }}>
                  S
                </div>
              </div>
            </motion.div>
      ...
      <section id="features" className="py-24 px-4" style={{ background: BG_LIGHT }}>
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div
              className="inline-block px-4 py-1.5 font-bold text-sm mb-4"
              style={{ background: MINT, color: "#FFFFFF", border: `3px solid ${BRUTAL_BLACK}` }}
            >
              ✦ FEATURES
            </div>
            <h2 className="text-4xl sm:text-5xl font-black mb-4" style={{ color: BRUTAL_BLACK }}>
              Everything You Need
            </h2>
            <p className="text-lg font-medium max-w-xl" style={{ color: "#555" }}>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: Layout, title: "Drag & Drop Builder", desc: "Intuitive visual editor. Just drag sections, drop them, and customize. It's that simple." },
              ...
              >
                <div
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.transform = "translate(-2px, -2px)";
                    e.currentTarget.style.boxShadow = `8px 8px 0px ${MINT}`;
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = "translate(0px, 0px)";
                    e.currentTarget.style.boxShadow = `6px 6px 0px ${BRUTAL_BLACK}`;
                  }}
                >
                  <div
                    className="w-14 h-14 flex items-center justify-center mb-6"
                    style={{ background: MINT_LIGHT, border: `3px solid ${BRUTAL_BLACK}` }}
                  >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div>
              <div
                className="inline-block px-4 py-1.5 font-bold text-sm mb-4"
                style={{ background: BRUTAL_BLACK, color: "#FFFFFF", border: `3px solid ${BRUTAL_BLACK}` }}
              >
                ✦ TEMPLATES
              </div>
              <h2 className="text-4xl sm:text-5xl font-black" style={{ color: BRUTAL_BLACK }}>
                Choose Your Style
              </h2>
            </div>
            <p className="font-medium max-w-xs" style={{ color: "#666" }}>
              8 expertly designed templates. Pick one and make it yours.
            </p>
          </motion.div>
              ...
              >
                ...
                >
                  <div className="relative h-44 overflow-hidden">
                    ...
                    />
                    <div
                      className="absolute top-3 left-3 px-2.5 py-1 font-bold text-xs"
                      style={{
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                >
                  <div
                    className="w-16 h-16 mx-auto mb-6 flex items-center justify-center font-black text-2xl"
                    style={{
                      background: MINT,
                      border: `3px solid ${BRUTAL_BLACK}`,
                      color: "#FFFFFF",
          ...
          >
            <BrutalCard mint className="p-10 sm:p-14 text-center">
              ...
              <div className="flex items-center justify-center gap-2 mb-2">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} className="w-5 h-5 fill-current" style={{ color: BRUTAL_BLACK }} />
                ))}
              </div>
              <cite className="font-bold text-sm not-italic" style={{ color: BRUTAL_BLACK }}>
      ...
      <section className="py-24 px-4" style={{ background: BRUTAL_BLACK }}>
        ...
        >
          <div
            className="inline-block px-4 py-1.5 font-bold text-sm mb-6"
            style={{ background: MINT, color: BRUTAL_BLACK, border: `3px solid #FFFFFF` }}
          >
            ✦ GET STARTED
          </div>
            ...
            <Link href={user ? "/dashboard" : "/auth/register"}>
              <span
                ...
                style={{
                  ...
                  boxShadow: `6px 6px 0px ${MINT_DEEP}`,
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.transform = "translate(2px, 2px)";
                  e.currentTarget.style.boxShadow = `4px 4px 0px ${MINT_DEEP}`;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.transform = "translate(0px, 0px)";
                  e.currentTarget.style.boxShadow = `6px 6px 0px ${MINT_DEEP}`;
                }}
              >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <div
                ...
                style={{ background: MINT, border: `2px solid #FFFFFF` }}
              >
                <span className="text-white font-black text-sm" style={{ fontFamily: "monospace" }}>S</span>
              </div>
